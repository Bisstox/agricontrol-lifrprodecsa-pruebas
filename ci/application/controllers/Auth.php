...
class Auth extends CI_Controller
{
	...
	private function _init()
	{
		...
		if($this->session->userdata('username')) {
			$grupo_id = $grupo = $this->ion_auth->get_users_groups()->row()->id;
		} else {
			$grupo_id = 0;
		}
	...
	public function index()
	{
		...
		else if (!$this->ion_auth->is_admin()) // remove this elseif if you want to enable this for non-admins
		{
			...
			show_error('Debes ser un administrador para poder acceder a esta página.');
		}
		else
		{
	...
	public function login()
	{
		...
		else
		{
			...
			$this->load->css('assets/themes/default/hero_files/login.css');
			// End custom Inorizonti
