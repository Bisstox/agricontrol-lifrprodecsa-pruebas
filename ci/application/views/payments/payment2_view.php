...
<form method="post" action="<?= site_url('payment/save_deductions') ?>">
    <table class="table">
        <thead>
            <tr>
                <th>#</th>
        ...
        <tbody>
            <?php foreach ($resume_data as $row): ?>
                ...
                <tr>
                    ...
                    <!-- Campo de deducción -->
                    <td>
                        <input type="number" name="deductions[<?= $row->operator_id ?>][deduction]" class="form-control"
                            step="0.001" value="0">
                    </td>
                    ...
                    <!-- Observación -->
                    <td>
                        <input type="text" name="deductions[<?= $row->operator_id ?>][observation]" class="form-control">
                    </td>

                    <input type="hidden" name="deductions[<?= $row->operator_id ?>][operator_id]"
                        value="<?= $row->operator_id ?>">

                    <input type="hidden" name="deductions[<?= $row->operator_id ?>][farm_id]" value="<?= $row->farm_id ?>">

                    <input type="hidden" name="deductions[<?= $row->operator_id ?>][selected_week]"
                        value="<?= $selected_week ?>">
                </tr>
            <?php endforeach; ?>
        </tbody>
