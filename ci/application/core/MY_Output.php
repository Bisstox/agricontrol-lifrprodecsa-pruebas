...
class MY_Output extends CI_Output {
	 ...
	 * @return void
	 */
	 // $data_template = null agregado por @raymundo el 2021-02-28
	function set_template($template_view, $data_template = null){
		...
		$this->_output_data['data_template'] = $data_template; // agregado por @raymundo el 2021-02-28
	}
